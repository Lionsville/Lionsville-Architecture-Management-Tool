...
const MAY_IMPORT = {
  ...
  technology: ['model', 'i18n', 'platform', 'widgets', 'business'],
...
const WHY = {
  ...
  technology: 'A platform\'s page is laid out from the rows that name it (ADR-0013), captured the way a sheet is. It does not know what a canvas is, nor a project.',
