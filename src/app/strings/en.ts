...
export const EN = {
  ...
  'change.observationAdded': 'Recorded the observation {name}',
  'change.observationRemoved': 'Removed the observation {name}',
  'change.observationChanged': 'Changed the observation {name} ({fields})',
  'change.causeAdded': 'Added the cause {name}',
  'change.causeRemoved': 'Removed the cause {name}',
  'change.causeChanged': 'Changed the cause {name} ({fields})',
  'change.solutionAdded': 'Added the solution {name}',
  'change.solutionRemoved': 'Removed the solution {name}',
  'change.solutionChanged': 'Changed the solution {name} ({fields})',
  'change.experimentAdded': 'Added the experiment {name}',
  'change.experimentRemoved': 'Removed the experiment {name}',
  'change.experimentChanged': 'Changed the experiment {name} ({fields})',
  ...
  'group.name': 'Name',
  'group.nameHelp': 'Renaming does not move it: the address ({path}) stays, and “Filed under” is what moves it.',
  'group.client': 'Client',
  ...
  'shell.observations': 'Observations',
  'shell.observationsTip': 'What was seen here and in the scopes below, analysed into causes and root causes',
  ...
  'org.kindHelp': 'Shown as a label; it changes nothing else.',
  ...
  'org.describeObservations': 'What the team observed here, how often, and the causes and root causes it was analysed into.',
  ...
  'org.technologyLandscape': 'Landscape',
  'org.technologyLandscapeMake': 'Make a landscape\u2026',
  ...
  'org.observationsOne': '{count} observation',
  'org.observationsOther': '{count} observations',
  'org.sharedBelowOne': '{count} shared from below',
  'org.sharedBelowOther': '{count} shared from below',
  'org.rootCausesOne': '{count} root cause',
  'org.rootCausesOther': '{count} root causes',
  ...
  'register.openRow': 'Open {name} where it is kept',
  ...
  'techRegister.title': 'Technology',
  'techRegister.what': 'Every platform service and platform across the organisation, derived from the tree: what is offered, what delivers it, and who leans on it.',
  'techRegister.servicesOne': '{count} service',
  'techRegister.servicesOther': '{count} services',
  'techRegister.platformsOne': '{count} platform',
  'techRegister.platformsOther': '{count} platforms',
  'techRegister.sharedOne': '{count} shared',
  'techRegister.sharedOther': '{count} shared',
  'techRegister.offeredOne': '{count} offered, not marked shared',
  'techRegister.offeredOther': '{count} offered, not marked shared',
  'techRegister.unrealisedOne': '{count} with nothing delivering it',
  'techRegister.unrealisedOther': '{count} with nothing delivering them',
  'techRegister.settled': 'Nothing the technology disagrees about.',
  'techRegister.unrealisedSentence': '{name} is offered, but no platform delivers it \u2014 add the platform that delivers it, or withdraw the service.',
  ...
  'techRegister.colName': 'Service or platform',
  'techRegister.colWho': 'Maintained by · sits in',
  'techRegister.colShared': 'Shared',
  'techRegister.colUse': 'Used by · hosts',
  'techRegister.colRealised': 'Delivered by · delivers',
  'techRegister.shared': 'Shared',
  'techRegister.ownTeam': 'Own team',
  'techRegister.nobodyMaintains': 'Nobody named',
  'techRegister.partOf': 'In {name}',
  'techRegister.hostsOne': '{count} hosted',
  'techRegister.hostsOther': '{count} hosted',
  'techRegister.unrealised': 'Nothing delivers it',
  'techRegister.realisesNothing': 'Delivers nothing',
  'techRegister.forService': 'For {name}',
  ...
  'library.placeTitle': 'How should {name} appear here?',
  'library.placeDomain': 'An application from another domain',
  'library.placeDomainWhat': 'On the landscape, drawn as the application it is. Double-click opens it where it is defined.',
  'library.placeExternal': 'An external reference',
  'library.placeExternalWhat': 'In the external band, drawn as a system outside this landscape.',
