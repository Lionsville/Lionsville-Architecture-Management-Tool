...
export const NL: Record<keyof typeof EN, string> = {
  ...
  'group.name': 'Naam',
  'group.nameHelp': 'Hernoemen geeft het een ander label. Het adres ({path}) verandert niet — “Ondergebracht bij” verplaatst het.',
  'group.client': 'Klant',
  ...
  'org.kind': 'Wat dit is',
  'org.kindHelp': 'Een woord dat het scherm toont. Er gedraagt zich niets anders.',
  ...
  'register.colMaster': 'Beheerd door',
  ...
  'techRegister.unrealisedOne': '{count} zonder iets dat het realiseert',
  'techRegister.unrealisedOther': '{count} zonder iets dat ze realiseert',
  'techRegister.settled': 'Niets waar de technologie over van mening verschilt.',
  'techRegister.unrealisedSentence': '{name} wordt aangeboden, maar geen platform levert het \u2014 voeg het platform toe dat het realiseert, of trek de dienst in.',
  ...
  'techRegister.colRealised': 'Gerealiseerd door · realiseert',
  ...
  'techRegister.unrealised': 'Niets realiseert het',
  'techRegister.realisesNothing': 'Realiseert niets',
