...
export const NL: Record<keyof typeof EN, string> = {
  ...
  'shell.savedWorkingFile':
    'WorkingFile bewaard, verzegeld met je wachtwoord — elke scope, inclusief geometrie, opmaak en eigen logo’s.',
  'seal.setTitle': 'WorkingFile verzegelen',
  'seal.setBody': 'Het bestand wordt met dit wachtwoord verzegeld, en wie het opent typt het opnieuw. Een verloren wachtwoord is niet terug te halen.',
  'seal.enterTitle': 'Verzegelde WorkingFile openen',
  'seal.enterBody': 'Deze WorkingFile is bij het bewaren met een wachtwoord verzegeld.',
  'seal.password': 'Wachtwoord',
  'seal.repeat': 'Herhaal het wachtwoord',
  'seal.mismatch': 'De twee komen niet overeen.',
  'seal.wrong': 'Dit is niet het wachtwoord waarmee dit bestand is verzegeld, of het bestand is beschadigd.',
  'seal.confirmSet': 'Bewaren',
  ...
  'openInto.newFolder': 'Een nieuwe map…',
  'openInto.unnamedHere': 'de werkmap',
  'openInto.occupiedTitle': 'Deze map is niet leeg',
  'openInto.occupiedBody': 'De map bevat al “{name}”. Het bestand daar openen schrijft eroverheen.',
  'openInto.occupiedConfirm': 'Vervangen',
  ...
  'history.beforeReplace': 'Voordat een werkbestand dit verving',
  'history.takenBeforeReplace': 'Eerst is een momentopname gemaakt: wat hier stond kan uit de geschiedenis teruggezet worden.',
  'history.failedBeforeReplace': 'Er is niets vervangen: er kon eerst geen momentopname gemaakt worden van wat hier staat. {message}',
  ...
  'change.observationAdded': 'Waarneming {name} vastgelegd',
  'change.observationRemoved': 'Waarneming {name} verwijderd',
  'change.observationChanged': 'Waarneming {name} gewijzigd ({fields})',
  'change.causeAdded': 'Oorzaak {name} toegevoegd',
  'change.causeRemoved': 'Oorzaak {name} verwijderd',
  'change.causeChanged': 'Oorzaak {name} gewijzigd ({fields})',
  'change.solutionAdded': 'Oplossing {name} toegevoegd',
  'change.solutionRemoved': 'Oplossing {name} verwijderd',
  'change.solutionChanged': 'Oplossing {name} gewijzigd ({fields})',
  'change.experimentAdded': 'Experiment {name} toegevoegd',
  'change.experimentRemoved': 'Experiment {name} verwijderd',
  'change.experimentChanged': 'Experiment {name} gewijzigd ({fields})',
  ...
  'picker.withBoard': 'Begin met een landschap',
  'picker.newScope': 'Nieuw domein of landschap\u2026',
  'picker.newScopeTitle': 'Nieuw domein of landschap',
  'picker.scopeName': 'Naam',
  'picker.under': 'Valt onder',
  'picker.addUnder': 'Nieuw domein of landschap onder {name}',
  ...
  'group.name': 'Naam',
  'group.nameHelp': 'Hernoemen verplaatst het niet: het adres ({path}) blijft, en “Ondergebracht bij” is wat het verplaatst.',
  'group.client': 'Klant',
  'group.clientHelp': 'Staat op elk geëxporteerd aanzicht. Leeg betekent de dichtstbijzijnde naam erboven.',
  ...
  'group.renamed': 'Hernoemd naar “{name}”.',
  'group.saveFailed': 'Dit onderdeel kon niet worden opgeslagen.',
  ...
  'agent.someone': 'Een agent',
  'agent.driving': '{name} bestuurt de app.',
  'agent.drivingFor': '{name} bestuurt de app: {purpose}',
  'agent.drivingHint': 'Wat u ondertussen aanklikt, kan veranderen wat de agent doet. Stoppen be\u00ebindigt de sessie en zegt dat tegen de agent.',
  'agent.stop': 'Stoppen',
  ...
  'shell.observations': 'Waarnemingen',
  'shell.observationsTip': 'Wat hier en in de scopes eronder gezien is, geanalyseerd naar oorzaken en grondoorzaken',
  ...
  'org.kind': 'Wat dit is',
  'org.kindHelp': 'Getoond als label; het verandert verder niets.',
  'org.kindNone': 'Niet gezegd',
  'org.kindOrganisation': 'Organisatie',
  'org.kindDomain': 'Domein',
  'org.kindProgramme': 'Programma',
  'org.kindTeam': 'Team',
  'org.kindLandscape': 'Landschap',
  'org.filedUnder': 'Ondergebracht bij',
  'org.filedUnderHelp': 'Verplaatsen verandert het adres van dit onderdeel en van alles eronder. De inhoud blijft ongemoeid.',

  'org.nameThis': 'Geef deze organisatie een naam',
  'org.forClient': 'Voor {name}',
  'org.lastChanged': 'Laatst gewijzigd {when}',
  'org.subtitleWhere': 'Alles hier wordt {where} bewaard.',
  'org.subtitle': 'Elk domein en landschap hieronder is een scope op zichzelf, met eigen borden, pagina\'s en besluiten.',
  'org.whereFolder': 'als bestanden in de map hierboven',
  'org.whereBrowser': 'in deze browser',
  'org.whereMemory': 'nog nergens \u2014 bewaar een werkbestand om het te houden',
  ...
  'org.describeDocumentation': 'Een pagina voor elk record op de borden van deze scope: eigenaar, leverancier, data en beschrijving.',
  'org.describeBusiness': 'Wat de organisatie doet: haar reizen, de gebieden die ze doorlopen, de functies in elk, en wie verantwoordelijk is.',
  'org.describeDecisions': 'De architectuurbesluiten die hier zijn genomen, genummerd, met hun status en de redenering achter elk.',
  'org.describeRoadmap': 'De plannen om dit landschap te veranderen op een tijdas, met wat elk introduceert en uitfaseert.',
  'org.describeObservations': 'Wat het team hier waarnam, hoe vaak, en de oorzaken en grondoorzaken waarnaar het geanalyseerd is.',
  'org.describeRegister': 'Elke applicatie waar dan ook in de organisatie, met de scope die ervoor instaat en waar ze verder getekend is.',
  ...
  'org.technologyLandscape': 'Landschap',
  'org.technologyLandscapeMake': 'Een landschap maken\u2026',
  'org.journeysOne': '{count} klantreis',
  'org.journeysOther': '{count} klantreizen',
  'org.areasOne': '{count} gebied',
  'org.areasOther': '{count} gebieden',
  'org.functionsOne': '{count} functie',
  'org.functionsOther': '{count} functies',
  'org.stakeholdersOne': '{count} belanghebbende',
  'org.stakeholdersOther': '{count} belanghebbenden',
  ...
  'org.boards': 'Borden',
  'org.newBoard': 'Nieuw bord\u2026',
  'org.newBoardLandscape': 'Landschap\u2026',
  'org.newBoardSheet': 'Bedrijfsarchitectuur',
  'org.newBoardMap': 'Enterprisekaart',
  'org.newBoardTechnology': 'Technologielandschap',
  'org.noBoards': 'Op dit niveau is nog niets getekend.',
  'org.boardName': 'Naam',
  'org.viewLayer7': 'Landschap',
  'org.viewContainer': 'Containers',
  'org.viewTechnology': 'Technologielandschap · opgemaakt uit de regels',
  'org.viewSheet': 'Bedrijfsarchitectuur · opgemaakt uit de bomen',
  'org.viewMap': 'Bedrijfskaart · opgemaakt uit de regels',
  'org.viewAsOf': 'Per {date}',
  'org.viewToday': 'Vandaag',
  'org.onItOne': '{count} erop',
  'org.onItOther': '{count} erop',
  ...
  'org.initiativesOne': '{count} initiatief van eronder',
  'org.initiativesOther': '{count} initiatieven van eronder',
  'org.observationsOne': '{count} waarneming',
  'org.observationsOther': '{count} waarnemingen',
  'org.sharedBelowOne': '{count} gedeeld van onderaf',
  'org.sharedBelowOther': '{count} gedeeld van onderaf',
  'org.rootCausesOne': '{count} grondoorzaak',
  'org.rootCausesOther': '{count} grondoorzaken',
  'org.noFindings': 'Niets waarover de datums het oneens zijn.',
  ...
  'org.treeEmpty': 'Er is nog niets ondergebracht bij {name}. Voeg er een domein of een landschap onder toe.',
  'org.expand': 'Toon wat onder {name} zit',
  'org.collapse': 'Verberg wat onder {name} zit',

  'org.copyHere': 'In deze map kopi\u00ebren\u2026',

  'register.title': 'Register',
  'register.what': 'Elke applicatie in de organisatie, afgeleid uit de boom.',
  'register.applicationsOne': '{count} applicatie',
  'register.applicationsOther': '{count} applicaties',
  'register.ownedOne': '{count} beheerd door een domein',
  'register.ownedOther': '{count} beheerd door een domein',
  'register.outsideOne': '{count} van buiten',
  'register.outsideOther': '{count} van buiten',
  'register.definedTwiceOne': '{count} dubbel gedefinieerd',
  'register.definedTwiceOther': '{count} dubbel gedefinieerd',
  'register.unattributedOne': '{count} van buiten zonder eigenaar',
  'register.unattributedOther': '{count} van buiten zonder eigenaar',
  'register.staleOne': '{count} met een verouderde verwijzing',
  'register.staleOther': '{count} met verouderde verwijzingen',
  'register.settled': 'Niets waar het register het niet over eens is.',
  'register.empty': 'Nog nergens in deze organisatie is een applicatie gedefinieerd.',
  'register.noMatch': 'Geen applicatie komt overeen met \u201c{query}\u201d.',
  'register.filter': 'Filter',
  'register.order': 'Volgorde',
  'register.byName': 'Op naam',
  'register.byScope': 'Op niveau',
  'register.colName': 'Applicatie',
  'register.colMaster': 'Bijgehouden in',
  'register.colDrawn': 'Ook getekend in',
  'register.colFindings': 'Bevindingen',
  'register.nobody': 'Niemand',
  'register.outsideParty': 'Van buiten \u00b7 {name}',
  'register.outsideUnattributed': 'Van buiten \u00b7 niemand zei van wie',
  'register.drawnNowhere': 'Nergens anders',
  'register.drawnOne': '{count} niveau',
  'register.drawnOther': '{count} niveaus',
  'register.openRow': '{name} openen waar het wordt bijgehouden',
  ...
  'techRegister.what': 'Elke platformdienst en elk platform in de organisatie, afgeleid uit de boom: wat wordt aangeboden, wat het levert, en wie erop leunt.',
  'techRegister.servicesOne': '{count} dienst',
  'techRegister.servicesOther': '{count} diensten',
  'techRegister.platformsOne': '{count} platform',
  'techRegister.platformsOther': '{count} platforms',
  'techRegister.sharedOne': '{count} gedeeld',
  'techRegister.sharedOther': '{count} gedeeld',
  'techRegister.offeredOne': '{count} aangeboden, niet als gedeeld gemarkeerd',
  'techRegister.offeredOther': '{count} aangeboden, niet als gedeeld gemarkeerd',
  'techRegister.unrealisedOne': '{count} zonder iets dat het levert',
  'techRegister.unrealisedOther': '{count} zonder iets dat ze levert',
  'techRegister.settled': 'Niets waar de technologie over van mening verschilt.',
  'techRegister.unrealisedSentence': '{name} wordt aangeboden, maar geen platform levert het \u2014 voeg het platform toe dat het levert, of trek de dienst in.',
  'techRegister.empty': 'Nergens in deze organisatie is al een platformdienst of platform gedefinieerd.',
  'techRegister.noMatch': 'Niets in de technologie komt overeen met \u201c{query}\u201d.',
  'techRegister.byKind': 'Op soort',
  'techRegister.colName': 'Dienst of platform',
  'techRegister.colWho': 'Onderhouden door · valt onder',
  'techRegister.colShared': 'Gedeeld',
  'techRegister.colUse': 'Gebruikt door · host',
  'techRegister.colRealised': 'Geleverd door · levert',
  'techRegister.shared': 'Gedeeld',
  'techRegister.ownTeam': 'Eigen team',
  'techRegister.nobodyMaintains': 'Niemand genoemd',
  'techRegister.partOf': 'In {name}',
  'techRegister.hostsOne': '{count} gehost',
  'techRegister.hostsOther': '{count} gehost',
  'techRegister.unrealised': 'Niets levert het',
  'techRegister.realisesNothing': 'Levert niets',
  'techRegister.forService': 'Voor {name}',

  'gesture.move': 'Verplaatsen\u2026',
  'gesture.moveTip': 'Dit record naar een ander niveau verplaatsen, of laten verwijzen naar een definitie elders',
  ...
  'gesture.demoteWhat': 'De definitie naar een niveau hieronder verplaatsen en hier een verwijzing achterlaten.',
  'gesture.transfer': 'Overdragen',
  'gesture.transferWhat': 'De definitie naar een ander niveau verplaatsen.',
  'gesture.to': 'Naar',
  'gesture.keepStandIn': 'Hier een verwijzing achterlaten',
  'gesture.keepStandInHelp': 'Zonder verwijzing tekent dit niveau het niet meer.',
  'gesture.go': 'Verplaatsen',
  'gesture.confirmTitle': '{scope} laten beheren over {name}?',
  'gesture.confirmBody': 'Dit schrijft twee niveaus: eerst {scope}, dan dit. Ongedaan maken stopt daar \u2014 verplaats het record opnieuw om het terug te zetten.',
  ...
  'library.placeTitle': 'Hoe moet {name} hier verschijnen?',
  'library.placeDomain': 'Een applicatie uit een ander domein',
  'library.placeDomainWhat': 'Op het landschap, getekend als de applicatie die het is. Dubbelklikken opent het waar het gedefinieerd is.',
  'library.placeExternal': 'Een externe verwijzing',
  'library.placeExternalWhat': 'In de externe band, getekend als een systeem buiten dit landschap.',
