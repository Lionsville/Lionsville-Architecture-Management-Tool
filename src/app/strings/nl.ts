...
export const NL: Record<keyof typeof EN, string> = {
  ...
  'openInto.hereWarning': 'Vervangen schrijft over “{scope}” en elke scope eronder heen. Wat er nu staat blijft alleen bewaard waar de map een momentopname heeft.',
