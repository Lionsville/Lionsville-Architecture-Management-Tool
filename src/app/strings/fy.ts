...
export const FY: Record<keyof typeof EN, string> = {
  ...
  'techRegister.unrealisedOne': '{count} sûnder wat dat it realisearret',
  'techRegister.unrealisedOther': '{count} sûnder wat dat se realisearret',
  'techRegister.settled': 'Neat dêr\'t de technology oer fan miening ferskilt.',
  'techRegister.unrealisedSentence': '{name} wurdt oanbean, mar gjin platfoarm leveret it \u2014 foegje it platfoarm ta dat it realisearret, of lûk de tsjinst yn.',
  ...
  'techRegister.colRealised': 'Realisearre troch · realisearret',
  ...
  'techRegister.unrealised': 'Neat realisearret it',
  'techRegister.realisesNothing': 'Realisearret neat',
