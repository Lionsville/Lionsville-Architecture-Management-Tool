...
export const DE: Record<keyof typeof EN, string> = {
  ...
  'techRegister.unrealisedOne': '{count} ohne etwas, das ihn realisiert',
  'techRegister.unrealisedOther': '{count} ohne etwas, das sie realisiert',
  'techRegister.settled': 'Nichts, worüber die Technologie uneins ist.',
  'techRegister.unrealisedSentence': '{name} wird angeboten, aber keine Plattform liefert es \u2014 fügen Sie die realisierende Plattform hinzu, oder ziehen Sie den Dienst zurück.',
  ...
  'techRegister.colRealised': 'Realisiert durch · realisiert',
  ...
  'techRegister.unrealised': 'Nichts realisiert ihn',
  'techRegister.realisesNothing': 'Realisiert nichts',
