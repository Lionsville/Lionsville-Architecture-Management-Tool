...
export const DE: Record<keyof typeof EN, string> = {
  ...
  'shell.savedWorkingFile':
    'Arbeitsdatei gespeichert, mit Ihrem Passwort versiegelt — jeder Scope, einschließlich Geometrie, Gestaltung und eigener Logos.',
  'seal.setTitle': 'Arbeitsdatei versiegeln',
  'seal.setBody': 'Die Datei wird mit diesem Passwort versiegelt, und wer sie öffnet, gibt es erneut ein. Ein verlorenes Passwort lässt sich nicht wiederherstellen.',
  'seal.enterTitle': 'Versiegelte Arbeitsdatei öffnen',
  'seal.enterBody': 'Diese Arbeitsdatei wurde beim Speichern mit einem Passwort versiegelt.',
  'seal.password': 'Passwort',
  'seal.repeat': 'Passwort wiederholen',
  'seal.mismatch': 'Die beiden stimmen nicht überein.',
  'seal.wrong': 'Das ist nicht das Passwort, mit dem diese Datei versiegelt wurde, oder die Datei ist beschädigt.',
  'seal.confirmSet': 'Speichern',
  ...
  'openInto.newFolder': 'Ein neuer Ordner…',
  'openInto.unnamedHere': 'der Arbeitsordner',
  'openInto.occupiedTitle': 'Dieser Ordner ist nicht leer',
  'openInto.occupiedBody': 'Der Ordner enthält bereits „{name}“. Die Datei dort zu öffnen, überschreibt es.',
  'openInto.occupiedConfirm': 'Ersetzen',
  ...
  'history.beforeReplace': 'Bevor eine Arbeitsdatei dies ersetzte',
  'history.takenBeforeReplace': 'Zuerst wurde eine Momentaufnahme festgehalten: Was hier war, lässt sich aus dem Verlauf wiederherstellen.',
  'history.failedBeforeReplace': 'Nichts wurde ersetzt: Von dem, was hier ist, ließ sich zuerst keine Momentaufnahme festhalten. {message}',
  ...
  'change.observationAdded': 'Beobachtung {name} festgehalten',
  'change.observationRemoved': 'Beobachtung {name} entfernt',
  'change.observationChanged': 'Beobachtung {name} geändert ({fields})',
  'change.causeAdded': 'Ursache {name} hinzugefügt',
  'change.causeRemoved': 'Ursache {name} entfernt',
  'change.causeChanged': 'Ursache {name} geändert ({fields})',
  'change.solutionAdded': 'Lösung {name} hinzugefügt',
  'change.solutionRemoved': 'Lösung {name} entfernt',
  'change.solutionChanged': 'Lösung {name} geändert ({fields})',
  'change.experimentAdded': 'Experiment {name} hinzugefügt',
  'change.experimentRemoved': 'Experiment {name} entfernt',
  'change.experimentChanged': 'Experiment {name} geändert ({fields})',
  ...
  'picker.withBoard': 'Mit einer Landschaft beginnen',
  'picker.newScope': 'Neue Domäne oder Landschaft\u2026',
  'picker.newScopeTitle': 'Neue Domäne oder Landschaft',
  'picker.scopeName': 'Name',
  'picker.under': 'Abgelegt unter',
  'picker.addUnder': 'Neue Domäne oder Landschaft unter {name}',
  ...
  'group.name': 'Name',
  'group.nameHelp': 'Umbenennen verschiebt ihn nicht: die Adresse ({path}) bleibt, und „Abgelegt unter“ ist, was ihn verschiebt.',
  ...
  'agent.someone': 'Ein Agent',
  'agent.driving': '{name} steuert die App.',
  'agent.drivingFor': '{name} steuert die App: {purpose}',
  ...
  'shell.observations': 'Beobachtungen',
  'shell.observationsTip': 'Was hier und in den Scopes darunter gesehen wurde, analysiert zu Ursachen und Grundursachen',
  ...
  'org.kindHelp': 'Als Etikett gezeigt; es ändert sonst nichts.',
  ...
  'org.subtitleWhere': 'Alles hier wird {where} aufbewahrt.',
  'org.subtitle': 'Jede Domäne und Landschaft darunter ist ein eigener Bereich mit eigenen Tafeln, Seiten und Entscheidungen.',
  'org.whereFolder': 'als Dateien im Ordner oben',
  'org.whereBrowser': 'in diesem Browser',
  'org.whereMemory': 'noch nirgends \u2014 speichern Sie eine Arbeitsdatei, um es zu behalten',
  ...
  'org.describeDocumentation': 'Eine Seite für jeden Datensatz auf den Tafeln dieses Bereichs: Eigentümer, Anbieter, Daten und Beschreibung.',
  'org.describeBusiness': 'Was die Organisation tut: ihre Reisen, die Gebiete, die sie durchlaufen, die Funktionen in jedem, und wer verantwortlich ist.',
  'org.describeDecisions': 'Die hier getroffenen Architekturentscheidungen, nummeriert, mit Status und der Begründung hinter jeder.',
  'org.describeRoadmap': 'Die Pläne zur Veränderung dieser Landschaft auf einer Zeitachse, mit dem, was jeder einführt und ablöst.',
  'org.describeObservations': 'Was das Team hier beobachtet hat, wie oft, und die Ursachen und Grundursachen, zu denen es analysiert wurde.',
  'org.describeRegister': 'Jede Anwendung irgendwo in der Organisation, mit dem Bereich, der für sie einsteht, und wo sie sonst gezeichnet ist.',
  ...
  'org.technologyLandscape': 'Landschaft',
  'org.technologyLandscapeMake': 'Eine Landschaft anlegen\u2026',
  ...
  'org.boards': 'Tafeln',
  'org.newBoard': 'Neue Tafel\u2026',
  'org.newBoardLandscape': 'Landschaft\u2026',
  'org.newBoardSheet': 'Geschäftsarchitektur',
  'org.newBoardMap': 'Unternehmenskarte',
  'org.newBoardTechnology': 'Technologielandschaft',
  'org.noBoards': 'Auf dieser Ebene ist noch nichts gezeichnet.',
  'org.boardName': 'Name',
  ...
  'org.observationsOne': '{count} Beobachtung',
  'org.observationsOther': '{count} Beobachtungen',
  'org.sharedBelowOne': '{count} von unten geteilt',
  'org.sharedBelowOther': '{count} von unten geteilt',
  'org.rootCausesOne': '{count} Grundursache',
  'org.rootCausesOther': '{count} Grundursachen',
  'org.noFindings': 'Nichts, worüber die Daten sich widersprechen.',
  'org.statusCount': '{count} {status}',
  'org.register': 'Register',
  'org.technology': 'Technologie',
  'org.nothingHere': 'Auf dieser Ebene noch nichts.',

  'org.tree': 'Domänen und Landschaften',
  'org.treeEmpty': 'Unter {name} ist noch nichts abgelegt. Fügen Sie darunter eine Domäne oder eine Landschaft hinzu.',
  ...
  'register.openRow': '{name} dort \u00f6ffnen, wo es geführt wird',
  ...
  'techRegister.title': 'Technologie',
  'techRegister.what': 'Jeder Plattformdienst und jede Plattform der Organisation, aus dem Baum abgeleitet: was angeboten wird, was es liefert, und wer sich darauf stützt.',
  'techRegister.servicesOne': '{count} Dienst',
  'techRegister.servicesOther': '{count} Dienste',
  'techRegister.platformsOne': '{count} Plattform',
  'techRegister.platformsOther': '{count} Plattformen',
  'techRegister.sharedOne': '{count} geteilt',
  'techRegister.sharedOther': '{count} geteilt',
  'techRegister.offeredOne': '{count} angeboten, nicht als geteilt markiert',
  'techRegister.offeredOther': '{count} angeboten, nicht als geteilt markiert',
  'techRegister.unrealisedOne': '{count} ohne etwas, das ihn liefert',
  'techRegister.unrealisedOther': '{count} ohne etwas, das sie liefert',
  'techRegister.settled': 'Nichts, worüber die Technologie uneins ist.',
  'techRegister.unrealisedSentence': '{name} wird angeboten, aber keine Plattform liefert es \u2014 fügen Sie die liefernde Plattform hinzu, oder ziehen Sie den Dienst zurück.',
  'techRegister.empty': 'Nirgends in dieser Organisation ist bisher ein Plattformdienst oder eine Plattform definiert.',
  'techRegister.noMatch': 'Nichts in der Technologie passt zu \u201e{query}\u201c.',
  'techRegister.byKind': 'Nach Art',
  'techRegister.colName': 'Dienst oder Plattform',
  'techRegister.colWho': 'Gepflegt von · liegt in',
  'techRegister.colShared': 'Geteilt',
  'techRegister.colUse': 'Genutzt von · hostet',
  'techRegister.colRealised': 'Geliefert durch · liefert',
  'techRegister.shared': 'Geteilt',
  'techRegister.ownTeam': 'Eigenes Team',
  'techRegister.nobodyMaintains': 'Niemand benannt',
  'techRegister.partOf': 'In {name}',
  'techRegister.hostsOne': '{count} gehostet',
  'techRegister.hostsOther': '{count} gehostet',
  'techRegister.unrealised': 'Nichts liefert ihn',
  'techRegister.realisesNothing': 'Liefert nichts',
  'techRegister.forService': 'F\u00fcr {name}',
  ...
  'library.placeTitle': 'Wie soll {name} hier erscheinen?',
  'library.placeDomain': 'Eine Anwendung aus einer anderen Domäne',
  'library.placeDomainWhat': 'Auf der Landschaft, gezeichnet als die Anwendung, die sie ist. Ein Doppelklick öffnet sie dort, wo sie definiert ist.',
  'library.placeExternal': 'Ein externer Verweis',
  'library.placeExternalWhat': 'Im externen Band, gezeichnet als System außerhalb dieser Landschaft.',
