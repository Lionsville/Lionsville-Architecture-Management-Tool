...
import { linkElementRefs, outline } from '@lionsville/solution-design'
import type { MarkdownRenderOptions, Translate } from '@lionsville/solution-design'
import {
  formatAdrNumber, isAdrDeletable, isAdrLocked, transitionsFrom,
} from '../../core/adr'
import type { Adr, AdrSigner, AdrStatus, AdrVerdict } from '../../core/adr'
