...
export const NL: Record<keyof typeof EN, string> = {
  ...
  'kind.platformService': 'Platformdienst',
  ...
  'relation.realises': 'Levert',
  'relation.assigned': 'Toegewezen aan',
  'relation.uses': 'Gebruikt',
  'relation.hostedOn': 'Draait op',
  'platformArchetype.place': 'Plek',
  'platformArchetype.service': 'Dienst',
  'platformArchetype.network': 'Netwerk',
  ...
  'deletion.withStandIns': '{what} — waarvan {count} verwijzingen, die blijven staan waar ze gedefinieerd zijn',
  ...
  'activity.observationAdded': 'Waarneming {name} vastgelegd',
  'activity.observationChanged': 'Waarneming {name} gewijzigd',
  'activity.observationRemoved': 'Waarneming {name} verwijderd',
  'activity.causeAdded': 'Oorzaak {name} toegevoegd',
  'activity.causeChanged': 'Oorzaak {name} gewijzigd',
  'activity.causeRemoved': 'Oorzaak {name} verwijderd',
  'activity.solutionAdded': 'Oplossing {name} toegevoegd',
  'activity.solutionChanged': 'Oplossing {name} gewijzigd',
  'activity.solutionRemoved': 'Oplossing {name} verwijderd',
  'activity.experimentAdded': 'Experiment {name} toegevoegd',
  'activity.experimentChanged': 'Experiment {name} gewijzigd',
  'activity.experimentRemoved': 'Experiment {name} verwijderd',
