...
export const DE: Record<keyof typeof EN, string> = {
  ...
  'kind.platform': 'Plattform',
  'kind.platformService': 'Plattformdienst',
  ...
  'platformArchetype.place': 'Ort',
  'platformArchetype.service': 'Dienst',
  'platformArchetype.network': 'Netzwerk',
  ...
  'command.taken': 'Etwas hier hat diese Kennung bereits — jemand anders hat sie genommen, während diese Änderung entstand. Bitte noch einmal versuchen.',
  'command.notAField': 'Diese Änderung enthält ein Feld, das dieser Datensatz nicht hat, deshalb wurde nichts davon übernommen.',
  'command.ownedElsewhere': 'Dies ist ein Platzhalter: Lebenszyklus, Daten, Verantwortliche, Hersteller, Name und Beschreibung werden in dem Bereich geschrieben, der ihn definiert.',
  ...
  'deletion.withStandIns': '{what} — davon {count} Platzhalter, die dort bleiben, wo sie definiert sind',
  ...
  'activity.observationAdded': 'Beobachtung {name} festgehalten',
  'activity.observationChanged': 'Beobachtung {name} geändert',
  'activity.observationRemoved': 'Beobachtung {name} entfernt',
  'activity.causeAdded': 'Ursache {name} hinzugefügt',
  'activity.causeChanged': 'Ursache {name} geändert',
  'activity.causeRemoved': 'Ursache {name} entfernt',
  'activity.solutionAdded': 'Lösung {name} hinzugefügt',
  'activity.solutionChanged': 'Lösung {name} geändert',
  'activity.solutionRemoved': 'Lösung {name} entfernt',
  'activity.experimentAdded': 'Experiment {name} hinzugefügt',
  'activity.experimentChanged': 'Experiment {name} geändert',
  'activity.experimentRemoved': 'Experiment {name} entfernt',
