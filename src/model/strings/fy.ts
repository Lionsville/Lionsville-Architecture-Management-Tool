...
export const FY: Record<keyof typeof EN, string> = {
  ...
  'platformArchetype.place': 'Plak',
  'platformArchetype.service': 'Tsjinst',
  'platformArchetype.network': 'Netwurk',
  ...
  'command.taken': 'Der is hjir al wat mei dat id — in oare auteur naam it wylst dizze wiziging makke waard. Besykje it nochris.',
  'command.notAField': 'Dizze wiziging hat in fjild dat dit rekord net hat, dus der is neat fan trochfierd.',
  'command.ownedElsewhere': 'Dit is in ferwizing: de libbenssyklus, datums, eigner, leveransier, namme en beskriuwing wurde skreaun yn de scope dy\'t it definiearret.',
  ...
  'deletion.withStandIns': '{what} — wêrfan {count} ferwizings, dy\'t bliuwe wêr\'t se definiearre binne',
  ...
  'activity.observationAdded': 'Waarnimming {name} fêstlein',
  'activity.observationChanged': 'Waarnimming {name} wizige',
  'activity.observationRemoved': 'Waarnimming {name} fuortsmiten',
  'activity.causeAdded': 'Oarsaak {name} tafoege',
  'activity.causeChanged': 'Oarsaak {name} wizige',
  'activity.causeRemoved': 'Oarsaak {name} fuortsmiten',
  'activity.solutionAdded': 'Oplossing {name} tafoege',
  'activity.solutionChanged': 'Oplossing {name} wizige',
  'activity.solutionRemoved': 'Oplossing {name} fuortsmiten',
  'activity.experimentAdded': 'Eksperimint {name} tafoege',
  'activity.experimentChanged': 'Eksperimint {name} wizige',
  'activity.experimentRemoved': 'Eksperimint {name} fuortsmiten',
