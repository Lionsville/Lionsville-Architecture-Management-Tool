...
export const EN = {
  ...
  'activity.observationAdded': 'Recorded the observation {name}',
  'activity.observationChanged': 'Changed the observation {name}',
  ...
  'activity.solutionRemoved': 'Removed the solution {name}',
  'activity.experimentAdded': 'Added the experiment {name}',
  'activity.experimentChanged': 'Changed the experiment {name}',
  'activity.experimentRemoved': 'Removed the experiment {name}',
