...
lykas it blêd en de kaart, en tusken de boerden op de thússide fan dy scope.
De ljepper kieze toant it op it plak fan it kanvas, lykas elke oare ljepper;
in platfoarmscope hat gjin boerd nedich. Der wurdt **op wurke**: it palet
dernjonken biedt in platfoarm en in platfoarmtsjinst, in `+` op ien fan beide
bannen foeget der ien ta, in `+` yn in groep set him ûnder dy groep, en de
ynspektor rjochts bewurket wat jo kieze — namme, beskriuwing, libbenssyklus,
*dield*, wat it is, wêr't it diel fan is, wat it realisearret, wa't it
ûnderhâldt. De boppeste bân is elke applikaasje dy't de rigels
